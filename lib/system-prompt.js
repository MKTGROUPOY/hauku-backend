...
INTENTIO:
1. FAKTA ("mitä ainesosia X sisältää?") → vastaa suoraan tietokannasta, ei muuta
2. INFORMATIONAL ("miksi koira syö ruohoa?") → vastaa asiantuntijana
3. DIAGNOSTIC ("koiralla löysä vatsa") → auta ymmärtämään, älä suosittele ilman pyyntöä
4. SHOPPING ("mikä sopisi?") → suosittele tietokannasta, kysy tarvittaessa lisätietoja
5. VALIKOIMAKYSYMYS ("löytyykö X?") → vastaa suoraan

      ...
      edges {
        node {
          ...
          metafields(identifiers: [
            ...
            {namespace:"custom", key:"ikä"}
            {namespace:"custom", key:"koko"}
            {namespace:"custom", key:"vapaa"}
...
function normalizeProduct(node) {
  ...
  const vapaa = parseJson(meta['vapaa']);
  const ika = parseJson(meta['ikä']);
  const koko = parseJson(meta['koko']);

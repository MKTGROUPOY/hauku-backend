...
export function buildProductContext(products, filters) {
  ...
  lines.push('\n</tuotteet_tietokannasta>');
  lines.push('EHDOTON SÄÄNTÖ: Suosittele VAIN yllä listattuja tuotteita. ÄLÄ mainitse muita tuotteita – ei edes kertoaksesi miksi ne eivät sovi. Jos listalla ei ole tarpeeksi vaihtoehtoja, sano se rehellisesti. ÄLÄ KOSKAAN mainitse, keksi tai suosittele tuotteita jotka eivät ole tässä listassa – vaikka tietäisit niiden olevan olemassa muualla maailmassa. Jos sopivaa tuotetta ei listalla ole, sano se rehellisesti.');

...
export function buildProductContext(products, filters) {
  ...
  lines.push('\n</tuotteet_tietokannasta>');
  lines.push('SALLITUT TUOTTEET (voit mainita VAIN nämä nimet):\n${products.map(p=>p.n).join('\\n')}\n\nEHDOTON SÄÄNTÖ: Älä mainitse yhtään muuta tuotetta. Jos tuotteen nimi ei ole yllä, se on kielletty. Ei poikkeuksia.');

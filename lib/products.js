...
export function getProducts() {
  ...
  _products = raw.map(p => ({
    ...
    rasvatOljyt: Array.isArray(p.rasvat_oljyt) ? p.rasvat_oljyt : splitField(p.rasvat_oljyt),
    lisaaineet: p.lisaaineet || '',
    ruokatyyppi: p.ruokatyyppi || 'Kuivaruoka',
    alkupera: p.alkupera || '',
    ruoanTyyppi: p.ruoan_tyyppi || '',
    sailytys: Array.isArray(p.sailytys_ja_valmistus) ? p.sailytys_ja_valmistus : splitField(p.sailytys_ja_valmistus),
